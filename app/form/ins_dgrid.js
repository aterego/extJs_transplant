...
Ext.onReady(function() {
...

                {
                    ...
                    handler : function(){
                        grid.doExcelExport({
                            ...
                            destinationfile: 'პროცედურების სია_Liv_' + getParameterByName('pid') + '.xlsx'
                        });
                    }
                }
            ]
     ...
     */
    Ext.Ajax.request({
        url: '../../server/list/instrumental_list.php?pid=' + getParameterByName('pid') + '&rid=' + getParameterByName('rid') ,
        success: function(response){
            ...
            /*
            var column= Ext.getCmp('inslist').getView().getHeaderCt().child('.myColumnClass');
            //var column= Ext.getCmp('inslist').getView().getGridColumns();  // return all the columns of grid.
