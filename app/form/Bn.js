...
Ext.onReady(function() {
	...
	var storeBn=Ext.create('Ext.mod.store.Bn',{
	...
	var rightClickGroup=Ext.create('Ext.menu.Menu',{
		...
		items:[{
			...
			handler:function(btn){
				var grid=Ext.getCmp(id+'grid_bn').getStore();
				grid.reload();
	...
	var win = Ext.create('Ext.window.Window', {
		title: 'BnTx - აღრიცხვაზე მყოფ ძვლისტვინგადანერგილ პაციენტთა სია',
		closable: false,
		/*
		 width: 350,
		 height:400,
		...
		items:[{
			...
			listeners : {
				itemdblclick: function(dv, record, item, index, e) {
					var grid = Ext.getCmp(id+'grid_bn');
	...
	storeBn.on('load', function(store, records, successful){
		win.setTitle('BnTx - აღრიცხვაზე მყოფ ძვლისტვინგადანერგილ პაციენტთა სია - სულ ' +  store.getTotalCount());
	});
	...
	function CreateEditPatient(data){
...

				{
					...
					handler : function(){
						...
						grid.doExcelExport({
							...
							startCell: 'B8',
							templatefile: "temp.xlsx",
							destinationfile: 'ლაბოროტორია_Bn_' + data.id + '.xlsx'
						});
					}
				}
...

				{
					...
					handler : function(){
						...
						grid.doExcelExport({
							...
							startCell: 'B8',
							templatefile: "temp.xlsx",
							destinationfile: 'ინსტრუმენტალური_Bn_' + data.id + '.xlsx'
						});
					}
				}
...

				{
					...
					handler : function(){
						...
						grid.doExcelExport({
							...
							startCell: 'B8',
							templatefile: "temp.xlsx",
							destinationfile: 'მკურნალობა_Bn_' + data.id + '.xlsx'
						});
					}
				}
...

						{
							...
							handler : function(){
								...
								grid.doExcelExport({
									...
									startCell: 'B8',
									templatefile: "temp.xlsx",
									destinationfile: 'იმუნოსუპრესია_Bn_' + data.id + '.xlsx'
								});
							}
						},
		...
		frmShowPatient= new Ext.window.Window({
			...
			x: 0,
			title: "BnTx " + data.id + " - " + data.patientname + " " + data.patientlastname,
			constrain: true,
			renderTo: Ext.getBody(),
			closable: true,
			autoScroll: true,
...

												{
													...
													handler : function(){
														...
														grid.doExcelExport({
															...
															startCell: 'B8',
															templatefile: "temp.xlsx",
															destinationfile: 'სამედიცინო ინფორმაცია_Bn_' + data.id + '.xlsx'
														});
													}
												}
...

												{
													...
													handler : function(){
														...
														grid.doExcelExport({
															...
															startCell: 'B8',
															templatefile: "temp.xlsx",
															destinationfile: 'დიალიზის ინფორმაცია_Bn_' + data.id + '.xlsx'
														});
													}
												}
...

												{
													...
													handler : function(){
														...
														grid.doExcelExport({
															...
															startCell: 'B8',
															templatefile: "temp.xlsx",
															destinationfile: 'ავადმყოფობის ისტორია_Bn_' + data.id + '.xlsx'
														});
													}
												}
