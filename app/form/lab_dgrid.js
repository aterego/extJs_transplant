...
Ext.onReady(function() {
...

                {
                    ...
                    handler : function(){
                        grid.doExcelExport({
                            ...
                            destinationfile: 'ანალიზების სია_Liv_' + getParameterByName('pid') + '.xlsx'
                        });
                    }
                }
            ]
     ...
     */
    Ext.Ajax.request({
        url: '../../server/list/labaratory_list.php?pid=' + getParameterByName('pid') + '&rid=' + getParameterByName('rid') ,
